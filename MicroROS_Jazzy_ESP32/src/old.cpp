...
void fill_and_publish(
  ...
  msg->linear_acceleration.x = bno->getAccelX();
  msg->linear_acceleration.y = bno->getAccelY();
  msg->linear_acceleration.z = bno->getAccelZ();

  msg->angular_velocity.x = bno->getGyroX();
  msg->angular_velocity.y = bno->getGyroY();
  msg->angular_velocity.z = bno->getGyroZ();
